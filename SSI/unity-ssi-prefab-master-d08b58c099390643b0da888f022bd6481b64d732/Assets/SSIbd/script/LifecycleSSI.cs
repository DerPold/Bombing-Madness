...
public class LifecycleSSI : MonoBehaviour {
    ...
    void Start () {
        ...
        string XMLPipeLineLocation = "\"" + Application.dataPath + @"/SSIbd/Resources/SSIConfig/biomonitor-procFake.pipeline" + "\"";
        if (!useFakePipeline)
            XMLPipeLineLocation = "\"" + Application.dataPath + @"/SSIbd/Resources/SSIConfig/biomonitor-live.pipeline" + "\"";
